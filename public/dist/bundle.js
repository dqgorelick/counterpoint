...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderNotes() {
	  ...
	  (0, _jquery2.default)('.scale').html(function () {
	    return '<div class="scale-background"' + 'style="' + 'top:' + CANVAS_TOP + 'px;' + 'height:' + noteHeight + 'px;' + '" ' + '></div>';
	  }());
	}
	
	function initializeSettings() {
	  (0, _jquery2.default)('.note').css('top', CANVAS_TOP);
	}
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  (0, _jquery2.default)('.note').hover(function (evt) {
	    var note = (0, _jquery2.default)(this).attr("id");
	    console.log('hover');
	    sendNote(notes[note].midi);
	  });
...
/***/ function(module, exports) {
	...
	var Player = function () {
	  function Player(id, options, sendNote) {
	    ...
	    // create player span
	    $('.players').append('<div class="player" id="' + this.id + '"><span><div class="cursor-wrapper"><div class="cursor"></div><div class="cursor-right"></div></div></span></div>');
